...
const SkillIcon = ({ icon: Icon, label, index }) => {
    ...
    return (
        ...
        >
            <Icon className="w-6 h-6 sm:w-8 sm:h-8 mb-2 text-blue-500" />
...
const About = () => {
    ...
    return (
        <section id="about" className="py-12 sm:py-20 bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
            <div className="container mx-auto px-4">
                <motion.h2
                    className="text-3xl sm:text-4xl font-bold mb-8 sm:mb-12 text-center text-gray-800 dark:text-white"
                ...
                >
                    <motion.div variants={itemVariants} className="lg:w-1/2 mb-8 lg:mb-0">
                        <motion.p
                            className="text-base sm:text-lg leading-relaxed text-gray-700 dark:text-gray-300 mb-4 sm:mb-6"
                    ...
                    <motion.div variants={itemVariants} className="lg:w-1/2 flex justify-center">
                        <div className="relative">
                            <img
                                ...
                                className="rounded-full w-48 h-48 sm:w-64 sm:h-64 object-cover border-4 border-blue-500 shadow-lg transform hover:scale-105 transition-transform duration-300"
                            />
                            <div className="absolute -top-4 -right-4 bg-blue-500 text-white rounded-full p-2 sm:p-3 animate-pulse">
                ...
                <motion.div
                    variants={containerVariants}
                    className="mt-12 sm:mt-16 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 sm:gap-8"
                >
                    <SkillIcon
                        icon={() => <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 sm:h-8 sm:w-8" viewBox="0 0 20 20" fill="currentColor">
