            ...
            <div className="container mx-auto px-4">
                ...
                >
                    {experienceData.map((job, index) => (
                        <motion.div
                            key={index}
                            className="mb-12 bg-white dark:bg-gray-700 rounded-xl shadow-lg overflow-hidden transform hover:scale-105 transition-transform duration-300"
                        ...
                        >
                            <div className="p-8">
                                ...
                                <div className="flex flex-wrap items-center mb-4 text-gray-600 dark:text-gray-300">
                                ...
                                <div className="flex flex-wrap justify-start gap-4">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center bg-blue-500 text-white px-6 py-3 rounded-full text-sm font-semibold hover:bg-blue-600 transition-colors duration-300 shadow-md"
                                    >
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center bg-green-500 text-white px-6 py-3 rounded-full text-sm font-semibold hover:bg-green-600 transition-colors duration-300 shadow-md"
                                    >
